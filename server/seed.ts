...
export async function seedDatabase() {
  ...
  const [agent1, agent2, agent3, agent4, agent5, agent6, agent7, agent8, agent9, agent10] = await db.insert(agents).values([
    ...
    },
    {
      ...
      erc8004TokenId: "1006",
      moltbookLink: "https://moltbook.io/@SentinelX",
      moltbookKarma: 3800,
      onChainScore: 760,
      fusedScore: 62.8,
    ...
    },
    {
      ...
      erc8004TokenId: "1007",
      moltbookLink: "https://moltbook.io/@DataCrab",
      moltbookKarma: 2100,
      onChainScore: 440,
      fusedScore: 35.2,
    ...
    },
    {
      ...
      erc8004TokenId: "1008",
      moltbookLink: "https://moltbook.io/@ShellShock",
      moltbookKarma: 4500,
      onChainScore: 510,
      fusedScore: 48.6,
    ...
    },
    {
      ...
      erc8004TokenId: "1009",
      moltbookLink: "https://moltbook.io/@ReefRunner",
      moltbookKarma: 6200,
      onChainScore: 820,
      fusedScore: 72.4,
    ...
    },
    {
      ...
      erc8004TokenId: "1010",
      moltbookLink: "https://moltbook.io/@TidePool",
      moltbookKarma: 1500,
      onChainScore: 380,
      fusedScore: 28.8,
