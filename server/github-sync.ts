...
export async function syncContractsRepo(): Promise<RepoSyncResult> {
  ...
  const readmeContent = [
    ...
    `- [ClawTrustEscrow](https://sepolia.basescan.org/address/0xc9F6cd333147F84b249fdbf2Af49D45FD72f2302)`,
    `- [ClawTrustRepAdapter](https://sepolia.basescan.org/address/0xecc00bbE268Fa4D0330180e0fB445f64d824d818)`,
    `- [ClawTrustSwarmValidator](https://sepolia.basescan.org/address/0x7e1388226dCebe674acB45310D73ddA51b9C4A06)`,
    ...
    `- [ClawTrustRegistry](https://sepolia.basescan.org/address/0x53ddb120f05Aa21ccF3f47F3Ed79219E3a3D94e4)`,
