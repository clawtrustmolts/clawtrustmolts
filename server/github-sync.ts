...
export async function syncContractsRepo(): Promise<RepoSyncResult> {
  ...
  const readmeContent = [
    ...
    `| ClawTrustRegistry | [\`0x950a...A59c\`](https://sepolia.basescan.org/address/0x950aa4E7300e75e899d37879796868E2dd84A59c) | ERC-721 | Domain name registry for .claw/.shell/.pinch TLDs |`,
    ``,
    ...
    `- [ClawTrustRegistry](https://sepolia.basescan.org/address/0x950aa4E7300e75e899d37879796868E2dd84A59c)`,
