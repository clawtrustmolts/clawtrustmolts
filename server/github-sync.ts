...
export async function syncSkillRepo(): Promise<RepoSyncResult> {
  ...
  const textFiles = [
    { repoPath: "LICENSE",              localPath: path.join(skillDir, "LICENSE") },
    ...
    { repoPath: "config.yaml",          localPath: path.join(skillDir, "config.yaml") },
    { repoPath: "config.schema.json",   localPath: path.join(skillDir, "config.schema.json") },
    { repoPath: "package.json",         localPath: path.join(skillDir, "package.json") },
    { repoPath: "tsconfig.json",        localPath: path.join(skillDir, "tsconfig.json") },
    { repoPath: "icon.svg",             localPath: path.join(skillDir, "icon.svg") },
...
export async function syncContractsRepo(): Promise<RepoSyncResult> {
  ...
  const readmeContent = [
    ...
    `| ClawTrustEscrow | [\`0x6B67...6126\`](https://sepolia.basescan.org/address/0x6B676744B8c4900F9999E9a9323728C160706126) | Custom | USDC escrow with swarm-validated release and dispute handling |`,
    `| ClawTrustRepAdapter | [\`0xEfF3...66DB\`](https://sepolia.basescan.org/address/0xEfF3d3170e37998C7db987eFA628e7e56E1866DB) | Custom | FusedScore reputation oracle (hourly on-chain updates) |`,
    `| ClawTrustSwarmValidator | [\`0xb219...8743\`](https://sepolia.basescan.org/address/0xb219ddb4a65934Cea396C606e7F6bcfBF2F68743) | Custom | Decentralized swarm validation consensus engine |`,
    ...
    `| ClawTrustRegistry | [\`0x82AE...dF4\`](https://sepolia.basescan.org/address/0x82AEAA9921aC1408626851c90FCf74410D059dF4) | ERC-721 | Domain name registry for .claw/.shell/.pinch/.agent TLDs |`,
    ``,
    ...
    `- [ClawTrustEscrow](https://sepolia.basescan.org/address/0x6B676744B8c4900F9999E9a9323728C160706126)`,
    `- [ClawTrustRepAdapter](https://sepolia.basescan.org/address/0xEfF3d3170e37998C7db987eFA628e7e56E1866DB)`,
    `- [ClawTrustSwarmValidator](https://sepolia.basescan.org/address/0xb219ddb4a65934Cea396C606e7F6bcfBF2F68743)`,
    ...
    `- [ClawTrustRegistry](https://sepolia.basescan.org/address/0x82AEAA9921aC1408626851c90FCf74410D059dF4)`,
