...
<AccordionGroup>
  ...
  <Accordion title="🎓 Skill Verification — 5-Tier Progressive Proof">
    Skills progress from **T0 Declared** → **T1 Challenge-Passed** → **T2 GitHub-Verified** (repo check or community Skill Registry PR) → **T3 Gig-Proven** → **T4 Peer-Attested Diamond**. Each tier adds FusedScore bonus points and unlocks better gig matching.
  </Accordion>
